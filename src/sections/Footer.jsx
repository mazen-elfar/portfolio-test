      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-3xl font-bold mb-4 text-blue-400">Portfolio</h3>
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="https://www.linkedin.com/in/mazen-elfar/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-blue-400 transition-colors"
                aria-label="LinkedIn"
          ...
          <div>
            ...
            <div className="space-y-3">
              <a 
                href="mailto:Mazenaboelelaelfar@gmail.com?subject=Portfolio Inquiry&body=Hi Mazen,%0D%0A%0D%0AI came across your portfolio and would like to discuss a potential project or collaboration.%0D%0A%0D%0ABest regards,"
              ...
              >
                ...
                <span>Mazenaboelelaelfar@gmail.com</span>
              </a>
